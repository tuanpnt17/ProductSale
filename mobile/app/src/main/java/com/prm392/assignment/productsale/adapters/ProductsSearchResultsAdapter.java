...
public class ProductsSearchResultsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        else if (Data.get(position) == horizontalProductsLayoutObject)
            return TYPE_HORIZONTAL_PRODUCTS_VIEW_HOLDER;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (getItemViewType(position) == TYPE_PRODUCT_VIEW_HOLDER) {
            ...
            if (onlineRecyclerAdapter == null)
                onlineRecyclerAdapter = new ProductsCardAdapter(context, holder.recyclerView);
            ...
            onlineRecyclerAdapter.setLastItemReachedListener(new ProductsCardAdapter.LastItemReachedListener() {
                ...
                public void onLastItemReached() {
                    if (lastItemReachedListener != null)
                        lastItemReachedListener.onLastOnlineProductReached();
                }
            });
            ...
            if (Data.get(position) == onlineLabelLayoutObject)
                holder.label.setText(R.string.Online_Stores);
    ...
    public void onViewAttachedToWindow(@NonNull RecyclerView.ViewHolder holder) {
        ...
        if (holder.getAdapterPosition() == getLocalProductsCount() - 1 && lastItemReachedListener != null && !isLocalProductsLoading())
            lastItemReachedListener.onLastLocalProductReached();
    }
