...
import com.prm392.assignment.productsale.databinding.FragmentSortAndFilterDialogBinding;
...
//        }
    ...
    void updateSortAndFilterModel(){
        //Sorting
        int checkedRadioButtonId = vb.sortAndFilterDialogSortGroup.getCheckedRadioButtonId();
        if (checkedRadioButtonId == R.id.sortAndFilterDialog_sort_popularity) {
            sortAndFilterModel.setSortBy(SortAndFilterModel.SORT_POPULARITY);
        } else if (checkedRadioButtonId == R.id.sortAndFilterDialog_sort_priceAsc) {
            sortAndFilterModel.setSortBy(SortAndFilterModel.SORT_PRICE_ASC);
        } else if (checkedRadioButtonId == R.id.sortAndFilterDialog_sort_priceDsc) {
            sortAndFilterModel.setSortBy(SortAndFilterModel.SORT_PRICE_DSC);
        } else if (checkedRadioButtonId == R.id.sortAndFilterDialog_sort_rating) {
            sortAndFilterModel.setSortBy(SortAndFilterModel.SORT_RATING);
        } else if (checkedRadioButtonId == R.id.sortAndFilterDialog_sort_updateDateNewest) {
            sortAndFilterModel.setSortBy(SortAndFilterModel.SORT_NEWEST);
        } else if (checkedRadioButtonId == R.id.sortAndFilterDialog_sort_bestDeal) {
            sortAndFilterModel.setSortBy(SortAndFilterModel.SORT_BEST_DEAL);
        } else if (checkedRadioButtonId == R.id.sortAndFilterDialog_sort_nearestStore) {
